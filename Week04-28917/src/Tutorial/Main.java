...
public class Main {
	...
	//fill value in array of object
	public static void seedData() {
		matkuls[0] = new MataKuliah("IF402", "Pemrograman Berorientasi Objek", 3);
		matkuls[1] = new MataKuliah("IF110", "Dasar-dasar Pemrograman", 3);
	...
	public static void showData() {
		...
		for(MataKuliah matkul : matkuls) {
			...
			matkul.setKode("IF402");
			matkul.setNama("Pemrograman Berorientasi Objek");
			matkul.setSks(3);
		}
	}
